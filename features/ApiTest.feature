Feature: Test feature
  ...
  Scenario: POST Scenario
    When I read the JSON from file "/Users/nisum/Downloads/post.json" into Dictionary Key "PostUsers"
  ...
  Scenario: PUT Scenario
    When I read the JSON from file "/Users/nisum/Downloads/post.json" into Dictionary Key "PutUsers"
