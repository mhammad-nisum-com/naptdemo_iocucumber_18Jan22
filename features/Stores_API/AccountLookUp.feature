...
#***************** Initiate LookUp *****************
    ...
    When I read the JSON from file "/src/main/resources/testData/ALU_TestData/InitiateLookup.json" into Dictionary Key "PostUsers"
...
#*****************   Get Credit Lookup Scenario  *****************
    ...
    Examples:
      | postLookUp_Path                                             | piiData_Path                                               | Return_Code | Return_Message    |
      | /src/main/resources/testData/ALU_TestData/postLookUp.json   | /src/main/resources/testData/ALU_TestData/PIIData.xml      | 100         | ACCOUNT FOUND     |
      | /src/main/resources/testData/ALU_TestData/postLookUp.json   | /src/main/resources/testData/ALU_TestData/PIIDataError.xml | 300         | ACCOUNT NOT FOUND |
      | /src/main/resources/testData/ALU_TestData/postLookUp304.json| /src/main/resources/testData/ALU_TestData/PIIDataError.xml | 304         | Bank error        |
