...
Scenario: FILE 2 Testing Add to Cart feature of ebay on UI and Mobile
...
@AddToCart @Smoke @Regression
Scenario: FILE 2 Test Cart feature of ebay
Given that I navigate to eBay home
When I search for "iPhone 13"
Then I get the search results
When I select an item
...
@AddToCart @Smoke @Regression
Scenario: FILE 2 eBay add to cart feature test with invalid input
Given that I navigate to eBay home
