  ...
  And I verify that the json path "$.data[?(@.email=='michal.lawson@reqres.in')].email" for node "data >> node"  value is "[;qt;michael.lawson@reqres.in;qt;]" for the response with Dictionary Key "GetUsers"
  ...
  Then I verify that the response code is "202" for the response with Dictionary Key "PutUsers"
  ...
  Then I verify that the response code is "201" for the response with Dictionary Key "PutUsers"
